...
export class ReportsHistoryPopUp extends Component<any, ReportsHistoryPopUpState>{
    ...
    public async componentDidMount() {
        try {
            ...
            const response = await axios.get("https://digital-dev.landing-page-media.co.il/reports-by-user/?userId=" + user.userId);
    ...
    public watchReport = (report: ReportModel) => async (event: any) => {
        ...
        if (report.products?.length === 0) {
            const responseForProducts = await axios.get("https://digital-dev.landing-page-media.co.il/all-products");
